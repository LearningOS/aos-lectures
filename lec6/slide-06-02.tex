...
\begin{frame}[plain]
	...
	\begin{columns}
		...
		\begin{column}{.5\textwidth}
			\includegraphics[width=1.\textwidth]{c-unix-analysis}
		\end{column}
		
		\begin{column}{.5\textwidth}
			
			\includegraphics[width=1.\textwidth]{unix-line-of-code}
			
		\end{column}
%		http://www.tom-yam.or.jp/2238/src/  unix v6 9000~10000 lines of code
